...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div style="font-size: 25px;" class="card-header">{{ __('Login') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label style="font-size: 25px;" for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail ') }}</label>
                        ...
                        <div class="form-group row">
                            <label style="font-size: 25px;" for="password" class="col-md-4 col-form-label text-md-right">{{ __('Senha') }}</label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label style="font-size: 20px; color:black;" class="form-check-label" for="remember">
                                        {{ __('Lembrar de mim') }}
                                    </label>
                                </div>
                            </div>

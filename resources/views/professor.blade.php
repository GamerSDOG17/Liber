        ...
        <div class="modal-content">
          ...
          <div style=text-align:center; class="modal-body">
              ...
              <form>
                  ...
                  <div class="form-group row">
                    <label for="inputEscola" style="font-size: 20px;" class="col-sm-2 col-form-label mb-3">Escola: </label>
                    <div class="col-sm-10">
                      <input style="font-size: 15px;" type="text" class="form-control col-md-6" id="inputEscola" placeholder="Escola">
                    </div>
                    <label for="inputEmail" style="font-size: 20px;" class="col-sm-2 col-form-label mb-1">E-mail: </label>
                    <div class="col-sm-10">
                      <input style="font-size: 15px;" type="text" class="form-control col-md-6" id="inputEmail" placeholder="E-mail">
                    </div>  
                  </div>
                </div> 
                </form>
          ...
          <div style=text-align:center; class="modal-body">
              ...
              <form>
                <div class="col mt-5 mb-5">
                  <input style="height: 50px;font-size:45px; text-align:center;" type="text" class="form-control" placeholder="dd/mm/yyyy">
                </div>
              </form> 
          </div>         
